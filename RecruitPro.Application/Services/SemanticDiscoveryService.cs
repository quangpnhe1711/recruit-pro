...
public class SemanticDiscoveryService : ISemanticDiscoveryService
{
    ...
    public async Task<ApiResponse<SemanticCandidatesResponseDto>> SearchTalentPoolAsync(TalentPoolSearchRequest request)
    {
        ...
        {
            return ApiResponse<SemanticCandidatesResponseDto>.BadRequest("Please provide a search query or jobId.");
        }
    ...
    public async Task<ApiResponse<SemanticCandidatesResponseDto>> DiscoverCandidatesAsync(CandidateDiscoveryRequest request)
    {
        ...
        {
            return ApiResponse<SemanticCandidatesResponseDto>.BadRequest("Please provide a discovery query.");
        }
    ...
    public async Task<ApiResponse<SemanticCandidatesResponseDto>> GetSimilarCandidatesAsync(string candidateId, int page, int pageSize)
    {
        ...
        {
            return ApiResponse<SemanticCandidatesResponseDto>.NotFound("Candidate not found.");
        }
        ...
        {
            return ApiResponse<SemanticCandidatesResponseDto>.BadRequest("Candidate vector is unavailable.");
        }
    ...
    public async Task<ApiResponse<SemanticJobsResponseDto>> GetSimilarJobsAsync(string jobId, int page, int pageSize)
    {
        ...
        if (targetVector == null)
        {
            return ApiResponse<SemanticJobsResponseDto>.BadRequest("Job vector is unavailable.");
        }
    ...
    public async Task<ApiResponse<SemanticCandidatesResponseDto>> GetRecommendedCandidatesAsync(string jobId, int page, int pageSize)
    {
        ...
        if (jobVector == null)
        {
            return ApiResponse<SemanticCandidatesResponseDto>.BadRequest("Job vector is unavailable.");
        }
    ...
    private async Task<IReadOnlyList<double>> BuildTransientEmbeddingAsync(string text)
    {
        ...
        {
            throw new InvalidOperationException(result.FailureReason ?? "Embedding generation failed.");
        }
